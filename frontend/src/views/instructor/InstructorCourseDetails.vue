        ...
        <v-expansion-panels v-model="expandedModuleIndex">
          ...
          >
            ...
            <v-expansion-panel-content>
              ...
              <v-btn color="primary" class="mt-4" @click="navigateToAddQuiz(module.id)">
...
const navigateToAddQuiz = (moduleId: number) => {
  router.push(`/instructor/add-quiz?moduleId=${moduleId}`);
};
